...
<main>
  ...
  <section class="posts">
    <article class="post">
      <img class="post__image" src="/stripes.png" alt="">
        <h2 class="post__header">CSS Patronen</h2>
        <p class="post__paragraph">
          Sanne had een paar css patronen gemaakt in de we love web sessie. 
          Dit heeft me geïnspireerd om zelf ook verschillende patronen te maken.
          Ik ga proberen om de gestreepte patroon na te maken van sanne en een paar andere 
          patronen te maken die ik leuk vind...
        </p>
        <a class="post__link" href="/">Lees meer over CSS patronen »</a>
    </article>

    <article class="post">
      <img class="post__image" src="/cars.jpg" alt="">
      <h2 class="post__header">CSS Animaties</h2>
      <p class="post__paragraph">
        Animaties zijn een leuke manier om gebruikers 
        langer op je website te laten hangen. Ik ga laten 
        zien hoe ik verschillende animaties heb gemaakt. Ik 
        heb voor dit voorbeeld twee verschillende soorten animaties 
        gemaakt: Een flip animatie en een svg animatie met auto’s...
      </p>
      <a class="post__link" href="/">Lees meer over CSS animaties »</a>
    </article>

    <article class="post">
      <img class="post__image" src="/orange.jpg" alt="">
      <h2 class="post__header">CSS Lorem ipsum</h2>
      <p class="post__paragraph">
        Lorem ipsum dolor sit amet, consect adipiscing elit. Elit sed et 
        sed aliquam proin. Nullam tincidunt etiam mi erat. At in sit eleifend 
        etiam arcu. Sed donec in dolor pulvinar ornare enim mattis. Vitae amet 
        neque vivamus enim, amet magna. Sem scelerisque cursus risus lorem lectus...
      </p>
      <a class="post__link" href="/">Lees meer over CSS Lorem ipsum »</a>
    </article>
  </section>
</main>
